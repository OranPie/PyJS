...
class N:
    ...
    Program        = staticmethod(lambda body:           {"type": "Program", "body": body})
    Block          = staticmethod(lambda body:           {"type": "BlockStatement", "body": body})
    VarDecl        = staticmethod(lambda kind,decls:     {"type": "VariableDeclaration", "kind": kind, "declarations": decls})
    VarDeclarator  = staticmethod(lambda id,init=None,line=0: {"type": "VariableDeclarator", "id": id, "init": init, "line": line})
    FnDecl         = staticmethod(lambda name,params,body,async_=False,generator_=False: {"type": "FunctionDeclaration", "id": name, "params": params, "body": body, "async_": async_, "generator_": generator_})
    ClassDecl      = staticmethod(lambda name,super_,body,decorators=None: {"type": "ClassDeclaration", "id": name, "superClass": super_, "body": body, "decorators": decorators or []})
    ClassField     = staticmethod(lambda key, value, static_=False, decorators=None, computed=False, computed_key=None: {"type": "ClassField", "key": key, "value": value, "static_": static_, "decorators": decorators or [], "computed": computed, "computed_key": computed_key})
    Decorator      = staticmethod(lambda expr: {"type": "Decorator", "expression": expr})
    StaticBlock    = staticmethod(lambda body: {"type": "StaticBlock", "body": body})
    RetStmt        = staticmethod(lambda arg=None:       {"type": "ReturnStatement", "argument": arg})
    ThrowStmt      = staticmethod(lambda arg:            {"type": "ThrowStatement", "argument": arg})
    IfStmt         = staticmethod(lambda test,cons,alt:  {"type": "IfStatement", "test": test, "consequent": cons, "alternate": alt})
    WhileStmt      = staticmethod(lambda test,body:      {"type": "WhileStatement", "test": test, "body": body})
    DoWhileStmt    = staticmethod(lambda body,test:      {"type": "DoWhileStatement", "body": body, "test": test})
    ForStmt        = staticmethod(lambda init,test,upd,body: {"type": "ForStatement", "init": init, "test": test, "update": upd, "body": body})
    ForInStmt      = staticmethod(lambda left,right,body: {"type": "ForInStatement", "left": left, "right": right, "body": body})
    ForOfStmt      = staticmethod(lambda left,right,body,await_=False: {"type": "ForOfStatement", "left": left, "right": right, "body": body, "await_": await_})
    SwitchStmt     = staticmethod(lambda disc,cases,defb: {"type": "SwitchStatement", "discriminant": disc, "cases": cases, "defaultCase": defb if defb else None})
    SwitchCase     = staticmethod(lambda test,body,deflt=False: {"type": "SwitchCase", "test": test, "consequent": body, "default": deflt})
    TryStmt        = staticmethod(lambda blk,cb,fb:     {"type": "TryStatement", "block": blk, "handler": cb, "finalizer": fb})
    CatchClause    = staticmethod(lambda param,body:     {"type": "CatchClause", "param": param, "body": body})
    BreakStmt      = staticmethod(lambda label=None:     {"type": "BreakStatement", "label": label})
    ContStmt       = staticmethod(lambda label=None:     {"type": "ContinueStatement", "label": label})
    EmptyStmt      = staticmethod(lambda:                {"type": "EmptyStatement"})
    ExprStmt       = staticmethod(lambda expr:           {"type": "ExpressionStatement", "expression": expr})
    Lit            = staticmethod(lambda val,tp,line=0:  {"type": "Literal", "value": val, "raw": tp, "line": line})
    Id             = staticmethod(lambda name,line=0:    {"type": "Identifier", "name": name, "line": line})
    ArrExpr        = staticmethod(lambda elems:          {"type": "ArrayExpression", "elements": elems})
    ObjExpr        = staticmethod(lambda props:          {"type": "ObjectExpression", "properties": props})
    Prop           = staticmethod(lambda key,val,comp=False,short=False: {"type": "Property", "key": key, "value": val, "computed": comp, "shorthand": short})
    FnExpr         = staticmethod(lambda name,params,body,arrow=False,async_=False,generator_=False: {"type": "FunctionExpression", "id": name, "params": params, "body": body, "arrow": arrow, "async_": async_, "generator_": generator_})
    UnaryExpr      = staticmethod(lambda op,arg,pfx:    {"type": "UnaryExpression", "operator": op, "argument": arg, "prefix": pfx})
    BinExpr        = staticmethod(lambda op,l,r,line=0:  {"type": "BinaryExpression", "operator": op, "left": l, "right": r, "line": line})
    LogExpr        = staticmethod(lambda op,l,r:         {"type": "LogicalExpression", "operator": op, "left": l, "right": r})
    UpdateExpr     = staticmethod(lambda op,arg,pfx:     {"type": "UpdateExpression", "operator": op, "argument": arg, "prefix": pfx})
    AssignExpr     = staticmethod(lambda op,l,r:         {"type": "AssignmentExpression", "operator": op, "left": l, "right": r})
    CondExpr       = staticmethod(lambda test,alt,cons:  {"type": "ConditionalExpression", "test": test, "alternate": alt, "consequent": cons})
    MemberExpr     = staticmethod(lambda obj,prop,comp,optional=False:  {"type": "MemberExpression", "object": obj, "property": prop, "computed": comp, "optional": optional})
    CallExpr       = staticmethod(lambda callee,args,line=0,optional=False: {"type": "CallExpression", "callee": callee, "arguments": args, "line": line, "optional": optional})
    NewExpr        = staticmethod(lambda callee,args:    {"type": "NewExpression", "callee": callee, "arguments": args})
    SpreadExpr     = staticmethod(lambda arg:            {"type": "SpreadElement", "argument": arg})
    ThisExpr       = staticmethod(lambda:                {"type": "ThisExpression"})
    TemplateExpr   = staticmethod(lambda parts:          {"type": "TemplateLiteral", "quasis": parts})
    AwaitExpr      = staticmethod(lambda arg:            {"type": "AwaitExpression", "argument": arg})
    ForAwaitOfStmt = staticmethod(lambda left,right,body: {"type": "ForOfStatement", "left": left, "right": right, "body": body, "await_": True})
    ImportDecl     = staticmethod(lambda specifiers,source: {"type": "ImportDeclaration", "specifiers": specifiers, "source": source})
    ImportDefault  = staticmethod(lambda local: {"type": "ImportDefaultSpecifier", "local": local})
    ImportNs       = staticmethod(lambda local: {"type": "ImportNamespaceSpecifier", "local": local})
    ImportSpec     = staticmethod(lambda imported,local: {"type": "ImportSpecifier", "imported": imported, "local": local})
    ExportDecl     = staticmethod(lambda decl: {"type": "ExportNamedDeclaration", "declaration": decl, "specifiers": [], "source": None})
    ExportList     = staticmethod(lambda specifiers,source: {"type": "ExportNamedDeclaration", "declaration": None, "specifiers": specifiers, "source": source})
    ExportDefault  = staticmethod(lambda decl: {"type": "ExportDefaultDeclaration", "declaration": decl})
    UsingDecl      = staticmethod(lambda is_async, decls: {"type": "UsingDeclaration", "is_async": is_async, "declarations": decls})
